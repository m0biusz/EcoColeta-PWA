...
**Público:** moradores de uma região atendida por coleta e administradores autorizados. A região piloto, os dados municipais e a parceria comunitária ainda devem ser definidos; o material anterior não comprova validação com a prefeitura.
